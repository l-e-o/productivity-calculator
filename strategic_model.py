...
with tab2:
    ...
    c1, c2 = st.columns(2)
    with c1:
        solution_name = st.text_input("Solution Name", value="Cognitive Merchandise Financial Planning (CMFP)")
...
# =================================================================
# TAB 3: ROI REPORT (FULLY RESTORED CONTENT)
# =================================================================
with tab3:
    ...
    # --- FULL VERBOSE BOARD-LEVEL EXECUTIVE SUMMARY ---
